...
export class ProductListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProductDto>();
    ...
    public async edit(dto: ProductDto) {
    ...
    public async view(dto: ProductDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProductDto) {
    ...
    public async duplicate(dto: ProductDto) {
    ...
    public exportPdf(dto: ProductDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProductDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProductDto>) {
