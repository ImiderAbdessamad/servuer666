...
export class ClientListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ClientDto>();
    ...
    public async edit(dto: ClientDto) {
    ...
    public async view(dto: ClientDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ClientDto) {
    ...
    public async duplicate(dto: ClientDto) {
    ...
    public exportPdf(dto: ClientDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ClientDto> {
        return this.service.selections;
    }

    set selections(value: Array<ClientDto>) {
